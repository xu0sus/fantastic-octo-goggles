...
@tree.command(name="مساعدة",description="عرض مركز المساعدة العربي الشامل لجميع أنظمة البوت")
...
@tree.command(name="حول_البوت",description="عرض إصدار البوت ومعلوماته والأنظمة الموجودة فيه")
...
@tree.command(name="وقت_التشغيل",description="عرض مدة تشغيل البوت منذ آخر تشغيل")
...
@tree.command(name="حالة_البوت",description="عرض حالة البوت والـ latency والذاكرة وقاعدة البيانات")
...
@tree.command(name="سيرفر_صورة",description="عرض أيقونة السيرفر بجودة عالية")
...
@tree.command(name="ايموجي",description="عرض معلومات إيموجي مخصص باستخدام المعرف")
...
@tree.command(name="رتبة_تفاصيل",description="عرض تفاصيل رتبة بالمعرف")
...
@tree.command(name="قول",description="إرسال رسالة باسم البوت عبر أمر إداري")
...
@tree.command(name="إعلان",description="إرسال إعلان عربي منسق مع عنوان ومحتوى")
...
@tree.command(name="منح_فلوس",description="منح عملات لعضو من رصيد الإدارة")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="سحب_فلوس",description="سحب عملات من رصيد عضو إداريًا")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="تعيين_رصيد",description="تعيين رصيد عضو إلى قيمة محددة")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="احصائيات_اقتصاد",description="عرض إحصائيات اقتصاد السيرفر بالكامل")
...
@tree.command(name="سجل_تدقيق",description="عرض آخر العمليات الإدارية المسجلة")
...
@tree.command(name="احصائيات_عضو",description="عرض نشاط عضو من قاعدة بيانات البوت")
...
@tree.command(name="سجل_عضو",description="عرض السجل الإداري والاقتصادي لعضو")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="نسخة_احتياطية",description="إنشاء نسخة احتياطية فورية لقاعدة البيانات")
...
@tree.command(name="أمر_مخصص_إضافة",description="إنشاء رد مخصص يستدعى من نظام الأوامر المخصصة")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="أمر_مخصص_حذف",description="حذف أمر مخصص")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="أوامر_مخصصة",description="عرض جميع الأوامر المخصصة في السيرفر")
...
@tree.command(name="مكافأة_نشاط",description="منح مكافأة مالية لمستخدم نشط")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="توب_رسائل",description="عرض أكثر أعضاء السيرفر نشاطًا بالرسائل المسجلة")
...
@tree.command(name="إعادة_إعدادات_الاقتصاد",description="إعادة أسعار السوق الأساسية للسيرفر")
@app_commands.checks.has_permissions(administrator=True)
...
@tree.command(name="تدقيق_قاعدة_البيانات",description="فحص سلامة قاعدة بيانات البوت")
@app_commands.checks.has_permissions(administrator=True)
...
@tree.command(name="تنظيف_سجلات_قديمة",description="حذف سجلات التدقيق القديمة للحفاظ على حجم قاعدة البيانات")
@app_commands.checks.has_permissions(administrator=True)
...
@tree.command(name="فحص_صلاحيات",description="فحص صلاحيات البوت ورتبته في السيرفر")
...
@tree.command(name="رابط_الدعوة",description="إنشاء رابط دعوة دائم أو مؤقت إذا كانت صلاحيات البوت تسمح")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="معلومات_القناة",description="عرض معلومات القناة الحالية")
...
@tree.command(name="معلومات_البوت",description="عرض معلومات تقنية موسعة عن البوت")
...
@tree.command(name="رول",description="إضافة رتبة لعضو أو إزالتها")
...
@tree.command(name="تايم",description="تطبيق Timeout لمدة محددة")
...
@tree.command(name="اونتايم",description="إلغاء Timeout عن عضو")
@app_commands.checks.has_permissions(moderate_members=True)
...
@tree.command(name="تحذير",description="إضافة تحذير لعضو")
@app_commands.checks.has_permissions(moderate_members=True)
...
@tree.command(name="تحذيرات",description="عرض تحذيرات عضو")
@app_commands.checks.has_permissions(moderate_members=True)
...
@tree.command(name="لقب",description="تغيير لقب عضو فعليًا داخل السيرفر وحفظه")
...
@tree.command(name="لقب_إزالة",description="إزالة لقب عضو وإرجاعه للاسم الأساسي")
@app_commands.checks.has_permissions(manage_nicknames=True)
...
@tree.command(name="لقب_محفوظ",description="عرض اللقب المحفوظ لعضو")
...
@tree.command(name="اقتراح",description="إرسال اقتراح إلى قناة الاقتراحات")
...
@tree.command(name="اقتراحات_تعيين",description="تحديد قناة الاقتراحات")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="اقتراح_حالة",description="تغيير حالة اقتراح")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="تكت",description="إرسال لوحة التذاكر")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="ترحيب_تعيين",description="تحديد قناة الترحيب")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="تذاكر_تصنيف",description="تحديد Category للتذاكر")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="طاقم_تذاكر",description="تحديد رتبة فريق التذاكر")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="لوق",description="تحديد قناة السجلات")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="لفل",description="عرض مستوى وXP عضو")
...
@tree.command(name="توب_لفل",description="عرض أعلى أعضاء XP")
...
@tree.command(name="تحويل",description="تحويل أموال إلى عضو")
...
@tree.command(name="سوق",description="عرض أسعار السوق")
...
@tree.command(name="بيع",description="بيع عنصر")
@app_commands.choices(العنصر=[app_commands.Choice(name="سيارة",value="سيارة"),app_commands.Choice(name="ملعب",value="ملعب")])
...
@tree.command(name="ممتلكاتي",description="عرض ممتلكاتك")
...
@tree.command(name="كرة",description="لعبة مهاجم ضد حارس")
...
@tree.command(name="رسم",description="لعبة رسم: شاهد الصورة ثم أرسل رسمتك")
...
@tree.command(name="إعدادات",description="عرض إعدادات البوت الأساسية للسيرفر")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="ترتيب_اقتصاد",description="عرض أعلى أرصدة")
...
@tree.command(name="بنق",description="عرض سرعة استجابة البوت")
...
@tree.command(name="معلومات_السيرفر",description="عرض معلومات متقدمة عن السيرفر")
...
@tree.command(name="معلومات_عضو",description="عرض معلومات عضو بالتفصيل")
...
@tree.command(name="الصورة",description="عرض صورة عضو بجودة عالية")
@app_commands.describe(member="العضو")
...
@tree.command(name="معلومات_رتبة",description="عرض معلومات رتبة")
...
@tree.command(name="تنظيف",description="حذف عدد من الرسائل")
@app_commands.checks.has_permissions(manage_messages=True)
...
@tree.command(name="تنظيف_البوتات",description="حذف رسائل البوتات الأخيرة")
@app_commands.checks.has_permissions(manage_messages=True)
...
@tree.command(name="تبطيء",description="تعيين Slowmode للقناة")
...
@tree.command(name="قفل",description="قفل القناة أمام الأعضاء")
@app_commands.checks.has_permissions(manage_channels=True)
...
@tree.command(name="فتح",description="فتح القناة أمام الأعضاء")
@app_commands.checks.has_permissions(manage_channels=True)
...
@tree.command(name="طرد",description="طرد عضو مع تسجيل الحالة")
...
@tree.command(name="حظر",description="حظر عضو")
...
@tree.command(name="فك_حظر",description="فك حظر مستخدم بالمعرف")
@app_commands.checks.has_permissions(ban_members=True)
...
@tree.command(name="مخالفات",description="عرض سجل العقوبات لعضو")
@app_commands.checks.has_permissions(moderate_members=True)
@app_commands.describe(member="العضو")
...
@tree.command(name="ملاحظة",description="إضافة ملاحظة إدارية سرية على عضو")
@app_commands.checks.has_permissions(moderate_members=True)
...
@tree.command(name="ملاحظات",description="عرض الملاحظات الإدارية لعضو")
@app_commands.checks.has_permissions(moderate_members=True)
...
@tree.command(name="تعيين_أفك",description="تفعيل حالة AFK")
...
@tree.command(name="استطلاع",description="إنشاء استطلاع تفاعلي")
...
@tree.command(name="تذكير",description="إنشاء تذكير بعد مدة مثل 30m أو 2h أو 1d")
...
@tree.command(name="إدارة_الأوتومود",description="تشغيل أو إيقاف حماية الروابط والدعوات والسبام")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="كلمة_ممنوعة",description="إضافة كلمة إلى فلتر الكلمات")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="كلمات_ممنوعة",description="عرض الكلمات الممنوعة")
@app_commands.checks.has_permissions(manage_guild=True)
...
@tree.command(name="جائزة_مستوى",description="ربط رتبة بمستوى XP")
@app_commands.checks.has_permissions(manage_roles=True)
...
@tree.command(name="جوائز_المستويات",description="عرض جوائز مستويات XP")
...
@tree.command(name="راتب",description="استلام راتب يومي متقدم")
...
@tree.command(name="تحويل_آمن",description="تحويل عملات بمعاملة ذرية")
...
@tree.command(name="سجل_مالي",description="عرض آخر العمليات المالية")
...
@tree.command(name="توب_مستويات",description="أعلى أعضاء XP")
...
@tree.command(name="إحصائيات_البوت",description="إحصائيات تشغيل البوت")
...
@bot.event
async def on_ready():
    # Slash commands are synced in setup_hook after startup systems are initialized.
...
async def setup_hook():
    ...
    # Sync slash commands to every guild immediately.
...
# ----------------------------------------------------------------
@tree.command(name="v4_لوحة", description="لوحة التحكم الاحترافية العربية V4")
...
@tree.command(name="v4_صيانة", description="تفعيل أو تعطيل وضع الصيانة في السيرفر")
...
@tree.command(name="v4_معلومات", description="معلومات شاملة عن طبقة V4 وأنظمتها")
...
@tree.command(name="v4_تدقيق", description="عرض آخر سجلات التدقيق الاحترافية")
...
@tree.command(name="v4_فلاغ", description="إضافة علامة إدارية سرية لعضو")
...
@tree.command(name="v4_فلاغات", description="عرض العلامات الإدارية السرية لعضو")
...
@tree.command(name="v4_رسائل", description="إحصائيات الرسائل المرصودة في الذاكرة")
...
@tree.command(name="v4_مقاييس", description="عرض مقاييس أنظمة البوت في السيرفر")
...
@tree.command(name="v4_نسخة_بيانات", description="إنشاء نسخة SQL مستقلة من بيانات V4")
...
@tree.command(name="v4_مساعدة", description="مساعدة تفاعلية لأنظمة V4 العربية")
